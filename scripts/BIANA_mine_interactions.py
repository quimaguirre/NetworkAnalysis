...
def main():
    ...
    Example of command:
    python /home/quim/PHD/Projects/BIANA/mining_scripts/BIANA_mine_interactions.py -i /home/quim/PHD/Projects/BIANA/data/COVID_test.txt -t genesymbol -o /home/quim/PHD/Projects/BIANA/outputs/COVID_interactions.txt -v
    """
...
def create_network_by_biana_search(options):
    ...
    if id_type not in accepted_id_types:
        ...
        if options.verbose:
            print('Type of identifier introduced: {}'.format(options.id_type))
    ...
    session.create_network(  user_entity_set_id = 'proteome', 
                             level = 1,
    ...
    # OUTPUT COMMANDS
    session.output_user_entity_set_network(user_entity_set_id = 'proteome',
                                           out_method = open(options.output_file,'w').write, 
                                           node_attributes = [id_type, 'taxid'],
